...
// IMPORTANT: Update this URL to your actual Firebase Cloud Function URL
...
// const String backendBaseUrl = 'http://localhost:5001/your-project-id/us-central1/aiCoach';
...
class AiChatNotifier extends StateNotifier<List<AiConversation>> {
  ...
  Future<void> sendMessage(
    ...
    try {
      // Check for simple greetings first (no backend needed)
    ...
    debugPrint('⚠️ Retry attempt ${attempts + 1}/$maxRetries after error: $e');
        }
      }
  ...
  Future<String> _callBackendAPI(
    ...
    debugPrint('✅ Backend response: ${content.toString().substring(0, 50)}...');
  ...
  // Simple responses for common greetings (no API call needed)
